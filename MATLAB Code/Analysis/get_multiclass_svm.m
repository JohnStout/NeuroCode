...
function [probAvg,probStd,probAvgShuff,probStdShuff,pZ,statZ] = get_multiclass_svm(data,numClasses,classNames,numIter,numFeats,numObs,numbins)
...
prob3d = cat(3,probMat{:});
probAvg = mean(prob3d,3);
probStd = std(prob3d,[],3);
chance  = 0.25;
